...
namespace DailyPuzzle.Day9
{
   public class Puzzle : IPuzzle
   {
      ...
      private readonly List<long> Numbers = new List<long>
      {
         3,
         17,
         32,
      ...
      private const int TestPreamble = 5;
      private readonly List<long> TestNumbers = new List<long> // use preambleSize = 5
      {
         35,
         20,
         15,
