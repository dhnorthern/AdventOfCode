...
namespace DailyPuzzle.Day7
{
   ...
   {
      public string Name => "Luggage Processing";

      public void RunPart1()
      {
         const string searchBagName = "shiny gold";
         var bagCount = LuggageProcessor.GetNumberOfBagsWhichCanContain( searchBagName, LuggageProcessor.GetContainerRelationships( Rules ) );
         Console.WriteLine( $"Bags which can contain {searchBagName}: {bagCount}" );
      }

      public void RunPart2()
      {
         const string searchBagName = "shiny gold";
         var bagCount = LuggageProcessor.GetNumberOfBagsContainedWithin( searchBagName, LuggageProcessor.GetContainerRelationships( Rules ) );
         Console.WriteLine( $"Bags within {searchBagName}: {bagCount}" );
      }
      ...
      private readonly List<string> TestRules = new List<string>
      {
      ...
      private readonly List<string> Test2Rules = new List<string>
      {
