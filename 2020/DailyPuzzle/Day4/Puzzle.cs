...
namespace DailyPuzzle.Day4
{
   public class Puzzle : IPuzzle
   {
      ...
      private void Run( bool withRules )
      {
         ...
         foreach ( var line in Passports )
         {
            ...
            {
               validPassports += validator.IsValid( passport.ToString(), withRules ) ? 1 : 0;
               passport.Clear();
            }
         }

         Console.WriteLine( $"Valid passwords: {validPassports}" );
      }

      private readonly List<string> Passports = new List<string>
      {
         "byr:1937",
      ...
      private readonly List<string> TestPassports = new List<string>
      {
